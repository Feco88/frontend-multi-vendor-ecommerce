...
const Wishlist = () => {
 ...
 return (
  ...
  md:grid-cols-2 sm:grid-cols-1 gap-6'>
    {
     wishlist.map((p,i)=><div key={i} className='border
...
{/*A kép alól ugorjanak be a további ikonok*/}
      ...
      group-hover:bottom-3'>
       ...
       className='w-[38px] h-[38px] cursor-pointer bg-white flex
       ...
       <li className='w-[38px] h-[38px] cursor-pointer bg-white flex
       justify-center items-center rounded-full hover:bg-[#059473]
       hover:text-white hover:rotate-[720deg] transition-all'>
           <RiShoppingCartLine />
       </li>
