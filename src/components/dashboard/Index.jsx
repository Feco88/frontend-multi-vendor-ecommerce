...
const Index = () => {
  ...
  //adatok kinyerése a userInfo-ból, hogy hozzzáférjünk az id-hoz
 ...
 return (
  <div>
   <div className='grid grid-cols-3 md:grid-cols-1 gap-5'>
    ...
    p-5 bg-white rounded-md gap-5'>
     <div className='bg-green-100 w-[47px] h-[47px]
    ...
    p-5 bg-white rounded-md gap-5'>
     ...
     <span>Függőben lévő rendelés</span>
     </div>
    </div>
