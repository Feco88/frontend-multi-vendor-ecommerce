...
//loader hozzáadása
    ...
    <div className='bg-slate-200 mt-4'>
     <div className='w-full justify-center items-center p-10'>
      ...
      rounded-md'>
        ...
        text-slate-600 font-bold'>Regisztráció</h2>
    ...
    <div>
        <form onSubmit={register} className='text-slate-600'>
         <div className='flex flex-col gap-1 mb-2'>
          ...
          outline-none focus:border-green-500 rounded-md' type="text"
          name="name" id="name" placeholder='Teljes név' required/>
         </div>
    ...
    <button className='px-8 w-full py-2 bg-blue-500 shadow
    hover:shadow-blue-500/50 text-white rounded-md flex
    justify-center items-center gap-2 mb-3'>
        <span><FaFacebookF /></span>
        <span>Facebook regisztráció</span>
    </button>

    <button className='px-8 w-full py-2 bg-red-500 shadow
    hover:shadow-red-500/50 text-white rounded-md flex
    justify-center items-center gap-2 mb-3'>
        <span><FaGoogle /></span>
        <span>Google regisztráció</span>
    </button>
    </div>
    <div className='text-center text-slate-600 pt-1'>
     <p>Van már fiókod? <Link className='text-blue-500' to={'/login'}>
     Bejelentkezés</Link></p>
    </div>
